      ...
      this.axios('device/listAllDevice?pageIndex=1&pageSize=100000')
        .then(res => {
          ...
          data.forEach((item, index) => { //循环所有设备补全信息
            ...
            // let marker = new BMap.Marker(pt, {icon: myIcon}); // 生成点信息
          ...
          var pointCollection = new BMap.PointCollection(this.markerData, options);
